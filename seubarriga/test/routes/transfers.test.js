...
describe('Ao salvar uma transfereência válida...', () => {
  let transferId
  let income
  let outcome
  ...
  test('As transações equivalentes deve ter sido geradas', async () => {
...
describe('Ao tentar salvar uma transferência inválida...', () => {
  ...
  test('Não deve inserir se as contas de origem e destino forem as mesmas', () => testTemplate({ acc_dest_id: 10000 },'Não é possível transferir de uma conta para ela mesma'))
...
describe('Ao alterar uma transfereência válida...', () => {
  let transferId
  let income
  let outcome
