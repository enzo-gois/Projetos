...
exports.seed = (knex) => {
  ...
  .then(() => knex('users').insert([
    {id:10000, name: 'User #1', mail: 'user1@mail.com', passwd: '$2a$10$Rye3R.3XZcCcYwZxvAg0e.RJMMQTP9l77AejvonnjPpRegvPZZJFq'},
    {id:10001,name: 'User #2', mail: 'user2@mail.com', passwd: '$2a$10$Rye3R.3XZcCcYwZxvAg0e.RJMMQTP9l77AejvonnjPpRegvPZZJFq'}
