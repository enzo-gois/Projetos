...
exports.seed = (knex) => {
  return knex('users').insert([
    {id:10100, name: 'User #3', mail: 'user3@mail.com', passwd: '$2a$10$Rye3R.3XZcCcYwZxvAg0e.RJMMQTP9l77AejvonnjPpRegvPZZJFq'},
    {id:10101, name: 'User #4', mail: 'user4@mail.com', passwd: '$2a$10$Rye3R.3XZcCcYwZxvAg0e.RJMMQTP9l77AejvonnjPpRegvPZZJFq'},
    {id:10102, name: 'User #5', mail: 'user5@mail.com', passwd: '$2a$10$Rye3R.3XZcCcYwZxvAg0e.RJMMQTP9l77AejvonnjPpRegvPZZJFq'}
